//
//  MacOSATDriverServerService.swift
...
class MacOSATDriverServerService: NSObject, MacOSATDriverServerServiceProtocol {
  let logger = Logger(subsystem: "com.bocoup.MacOSATDriverServer", category: "service")
